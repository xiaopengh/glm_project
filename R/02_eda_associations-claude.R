...
# Pairs plot
p_pairs <- train_data |>
  select(y, study_hrs, attend_pct, sleep_hrs) |>
  ggpairs(
  ...
  labs(title = "Pairs Plot: Key Continuous Variables")

print(p_pairs)

ggsave("output/fig_10_pairs_plot.png", p_pairs,
...
message("\n1. Potential Confounders with School Type:")
...
# Check if parent education is confounded
